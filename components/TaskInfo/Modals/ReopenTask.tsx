    ...
    <View style={styles1.contain}>
          ...
          <KeyboardAvoidingView style={styles.whitebg} behavior={Platform.OS === "ios" ? "padding" : "height"}>
            ...
            <Modal.Content style={styles1.bottomModal} justifyContent={"center"}>
              ...
              <Modal.Header  style={{borderBottomWidth: 0, alignContent: "center", justifyContent:"center"}}><Text style={{fontWeight: "600", textAlign: "center", justifyContent:"center"}}>Reopen Task</Text></Modal.Header>
              <Modal.Body style={{borderBottomWidth: 0,}}>
                <Text style={{textAlign:"center"}}>You will need to enter a reason for reopening this task.</Text>
              </Modal.Body>
