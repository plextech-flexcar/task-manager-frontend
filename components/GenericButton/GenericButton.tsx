...
const GenericButton = ({ isPurple, imageSource, text, onPressFunction }: { isPurple: boolean, imageSource?: ImageSourcePropType, text: string, onPressFunction?: (even: GestureResponderEvent) => void }) => {
    return (
        <TouchableOpacity
